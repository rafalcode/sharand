...
bould_t *creabould(int nvert, float sz)
{
    bould_t *bould=malloc(sizeof(bould_t));
    bould->nvert=nvert;
    bould->xp=malloc(nvert*sizeof(float));
    bould->yp=malloc(nvert*sizeof(float));

    return bould;
}

void freebould(bould_t *bould)
{
    free(bould->xp);
    free(bould->yp);
    free(bould);
...
void boulder(cairo_surface_t *surface, cairo_t *cr, bould_t *bould)
{
